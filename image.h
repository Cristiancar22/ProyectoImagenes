...
public :
    ...
    /**
      * @brief Invierte .
      * @pre La imagen debe ser valida
      * @post El objeto que llama al método queda modificado
      */
    void Invert();
    ...
    /**
      * @brief Calcula la media de los píxeles de un fragmento de la imagen .
      * @param i fila de la esquina superior izquierda del fragmento.
      * @param j columna de la esquina superior izquierda del fragmento.
      * @param height filas del fragmento.
      * @param width columnas del fragmento.
      * @pre 0<= i <= filas , 0 <= j <= columnas
      * @return Devuelve un double como resultado de la media de los píxeles del fragmento.
      * @post La imagen no se modifica.
      */
    ...
    /**
      ...
      * @post La imagen no se modifica
      * @post La imagen resultante tendrá tamaño int(filas/factor) X int(columnas/factor). Descartando los decimales.
      */
    ...
    /**
      ...
      * @param width Numero de columna.
      * @pre filas > nrow >= 0 && col > ncol >= 0 && filas > height >= 1 && col > width >= 1.
      * @return Una imagen recortada de ncol * nrow dimesiones.
      * @post La imagen no se modifica.
      */
     ...
     * @pre La imagen debe ser cuadrada.
     * @return Una imagen aumentada 2x .
     * @post La imagen no se modifica.
     */
    Image Zoom2X() const;
